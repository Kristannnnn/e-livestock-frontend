...
export const apiRoutes = {
  ...
  notifications: {
    list: route("notifications/list", "notifications/get_notifications.php"),
    markRead: route(
    ...
    pushRegister: route(
      ...
      "notifications/register_push_token.php"
    ),
    pushUnregister: route(
      "notifications/push/unregister",
      "notifications/unregister_push_token.php"
    ),
  },
  renewals: {
    request: route("renewals/request", "renewals/request_renewal.php"),
    list: route("renewals/list", "renewals/get_requests.php"),
    details: route("renewals/details", "renewals/get_request_details.php"),
    cancel: route("renewals/cancel", "renewals/cancel_request.php"),
  },
  owner: {
